        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__.cookies.get({ name: 'KievRPSSecAuth', url: 'https://bing.com' })];
                case 3:
                    data = _a.concat([
                        (_d.value = (_e.sent()).value,
                            _d)
                    ]);
